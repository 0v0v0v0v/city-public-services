...
const quickEntries = [
  {
    title: '按分类进入',
    description: '先看公园、社区服务中心、政务大厅等分类，再进入对应点位列表。',
    to: '/categories',
    tag: '常用入口',
  },
  {
  ...
  {
    title: '进入后台录入',
    description: '管理员可以维护分类和点位，形成从录入到展示的完整流程。',
    to: '/admin',
    tag: '管理台',
  },
]
...
<template>
  <div class="space-y-10">
    <HeroBanner
      ...
      subtitle="整合城市公园、社区服务中心、政务大厅、公共卫生间等公益设施信息，帮助大家通过分类与搜索快速查询日常所需服务。"
    />

    <section class="grid gap-5 lg:grid-cols-[1.35fr_0.65fr]">
      <FeaturePanel
        badge="平台目标"
        title="先把高频民生信息整合清楚，再逐步扩展到更完整的服务能力。"
        description="首版围绕信息整合、分类浏览和后台录入三个核心动作构建，让系统先形成稳定可演示的使用闭环。"
      >
        <div class="grid gap-3 sm:grid-cols-3">
          <StatCard eyebrow="收录对象" value="4 类" description="首版覆盖课程演示常用公共设施。" tone="cyan" />
      ...
      <div class="grid gap-5 sm:grid-cols-2 lg:grid-cols-1">
        <StatCard eyebrow="建设方向" value="公益型平台" description="不做商业流量和广告，以公共服务可达性为核心。" />
    ...
    <section>
      <SectionTitle title="平台框架" subtitle="先搭好网站的主要入口和功能层次，后续再逐步补充真实数据。" />
